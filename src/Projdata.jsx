const topProj=[
    {
        ...
        vidUrl:"HYBtzKqGQOg",
        site:"https://vibegram.pranjalkv.com",
...

      {
        ...
        vidUrl:"PCBnYJcSerQ",
        site:"https://pkshop.pranjalkv.com",
  ...
  
       {
        ...
        slogan:"",
        desc:"Generate any image using Ai Generator made using Dall-E Api .Unfortunately due to limit of images that can be generated per month has exceeded the website is not available but you still see the source code and the video  ",
        urlPic:"/images/pr4.jpg",
        gitUrl:"https://github.com/pranjalkv/Image_Dalle",
        vidUrl:"QeL2OC9QQBE",
        site:"",
        techs:["JavaScript" ,"Dall-E_Api"]
    },
    {
        id:"5",
        title:"Drawing App",
        slogan:"",
        desc:"App made with HTML Canvas ,select color select background color and start drawing save image as png to your device",
        urlPic:"/images/pr5.jpg",
        gitUrl:"https://github.com/pranjalkv/drawing_app",
        vidUrl:"V_FTdulSeUE",
        site:"https://drawapp.pranjalkv.com",
